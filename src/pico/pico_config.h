...
#define PIN_BUTTON_E 4 
#define PIN_BUTTON_F 5

#define PIN_BUTTON_NEXT PIN_BUTTON_A
#define PIN_BUTTON_PREV PIN_BUTTON_B
#define PIN_BUTTON_OK PIN_BUTTON_D
#define PIN_BUTTON_BACK PIN_BUTTON_E
#define PIN_BUTTON_HOME PIN_BUTTON_F
#define PIN_BUTTON_SLEEP PIN_BUTTON_C
